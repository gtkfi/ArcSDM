"""
    ...
    Conversion 2016 Tero Ronkko / Geological survey of Finland
...
# Script arguments...
try:
    Input_point_features = gp.GetParameterAsText(0)
    Input_raster = gp.GetParameterAsText(1)
    Value_field = gp.GetParameterAsText(2)
    UnitArea = gp.GetParameter(3)
    Output_Table = gp.GetParameterAsText(4)
...
# Process: Summary Statistics...
    ...
    # Process: Add Field (3)...
    gp.AddField_management('output_table', "Area_sqkm", "DOUBLE", "", "", "", "Area Sq Kilometers", "NULLABLE", "NON_REQUIRED", "")

    # Process: Add Field (5)...
    gp.AddField_management('output_table', "CAPP_CumAr", "DOUBLE", "", "", "", "CAPP Cumulative Area", "NULLABLE", "NON_REQUIRED", "")
    #gp.AddMessage("got to here....9")

    # Process: Add Field (6)...
    gp.AddField_management('output_table', "Eff_CumAre", "DOUBLE", "", "", "", "Efficiency Cumulative Area", "NULLABLE", "NON_REQUIRED", "")
    #gp.AddMessage("got to here....10")

    # Process: Add Field (7)...
    gp.AddField_management('output_table', "Cum_Sites", "DOUBLE", "", "", "", "Cumulative Sites", "NULLABLE", "NON_REQUIRED", "")

    # Process: Add Field (7)...
    gp.AddField_management('output_table', "I_CumSites", "DOUBLE", "", "", "", "100-Cumulative Sites", "NULLABLE", "NON_REQUIRED", "")

    # Process: Add Field (7)...
    gp.AddField_management('output_table', "Eff_AUC", "DOUBLE", "", "", "", "A U C", "NULLABLE", "NON_REQUIRED", "")
