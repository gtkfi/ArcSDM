...
class ROCCalculator(object):
    ...
    def FetchCoordinates(self, path):
    ...
    def execute(self, parameters, messages):
        ...
        positives_x, positives_y = self.FetchCoordinates(positives_descr.catalogPath)
        ...
        for i in range(len(tokens)):
            ...
            _roc_curve, _roc_ints, _auc_value, _auc_confints = self.CalculateCurveForModel(messages, raster_descr, negatives_descr, positives_x, positives_y)
    ...
    def CalculateCurveForModel(self, messages, raster_descr, negatives_descr, positives_x, positives_y):
        ...
        if negatives_descr:
            negatives_x, negatives_y = self.FetchCoordinates(negatives_descr.catalogPath)
    ...
    def CalculateAUCValue(self, roc_curve):
        auc_value = 0
    ...
    def CalculateROCCurve(self, positive_sample, negative_sample):
