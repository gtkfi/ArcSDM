...
import arcsdm.machine_learning.mlp_common
...
def get_pytorch_optimizer(optimizer: str, params, learning_rate):
    ...
    if optimizer == arcsdm.machine_learning.mlp_common.OPTIMIZER_ADAM.lower():
        return optim.Adam(params, lr=learning_rate)
    elif optimizer == arcsdm.machine_learning.mlp_common.OPTIMIZER_ADAGRAD.lower():
        return optim.Adagrad(params, lr=learning_rate)
    elif optimizer == arcsdm.machine_learning.mlp_common.OPTIMIZER_RMSPROP.lower():
        return optim.RMSprop(params, lr=learning_rate)
    elif optimizer == arcsdm.machine_learning.mlp_common.OPTIMIZER_SGD.lower():
...
def get_pytorch_regression_loss(loss_function: str):
    ...
    if selected_loss in {
        arcsdm.machine_learning.mlp_common.LOSS_MSE.lower(),
        arcsdm.machine_learning.mlp_common.VALIDATION_MSE.lower()
    }:
        return nn.MSELoss()

    if selected_loss in {
        arcsdm.machine_learning.mlp_common.LOSS_L1.lower(),
        arcsdm.machine_learning.mlp_common.VALIDATION_L1.lower()
    }:
        return nn.L1Loss()

    if selected_loss in {
        arcsdm.machine_learning.mlp_common.LOSS_HUBER.lower()
    }:
        return nn.HuberLoss()
