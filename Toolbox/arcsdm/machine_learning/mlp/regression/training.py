...
from arcsdm.machine_learning.mlp.regression.data import read_regressor_target_array, validate_regressor_input_rasters
from arcsdm.machine_learning.mlp.regression.metrics import log_regression_validation_metric
...
def train_MLP_regressor(
    ...
    pytorch_optimizer = arcsdm.machine_learning.mlp.pytorch_utils.get_pytorch_optimizer(optimizer, model.parameters(), learning_rate)
    try:
        criterion = arcsdm.machine_learning.mlp.pytorch_utils.get_pytorch_regression_loss(loss_function)
    ...
    try:
        for epoch in range(epochs):
            train_loss = arcsdm.machine_learning.mlp.pytorch_utils.train_regression_epoch(device, training_loader, model, criterion, pytorch_optimizer)
            val_loss = arcsdm.machine_learning.mlp.pytorch_utils.evaluate_regression_epoch(device, testing_loader, model, criterion)
