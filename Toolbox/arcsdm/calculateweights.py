...
def Calculate(self, parameters, messages):
    ...
    # Process: ExtractValuesToPoints
        ...
        training_points_raster = arcsdm.workarounds_93.ExtractValuesToPoints(gp, EvidenceLayer, TrainingSites, "TPFID")
    # Process: Summarize Frequency and manage fields
        ...
        gp.Statistics_analysis(training_points_raster, Statistics, "rastervalu sum" ,"rastervalu")
    ...
    #Generalize table
        ...
        ds = gp.GetCount_management(training_points_raster) #TP selected
